 ...
 * You will be given the Collection Name and the RecordID.
 * This returns the HTML card of the records.
 * */
exports.getRecordStatusInfo = async function (req, res, next) {
    ...
    let expandedRecord = await UTILS.expand(recordID)
    .then(response => response.json())
    .catch(err => { return err })
    if (expandedRecord) {
 ...
 * 
 */
async function getCollectionManagedRecords(collectionName){
 ...
 * 
 */
async function getCollectionPublicRecords(collectionName){
